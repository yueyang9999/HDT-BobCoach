...
$output = Join-Path $env:TEMP "bobcoach_prize_spell_source_behavior.exe"
$sources = @(
    ...
    (Join-Path $PSScriptRoot "PrizeSpellFactSourceBehavior.cs"),
    (Join-Path $PSScriptRoot "PrizeSpellFactSourceHearthDbBehavior.cs")
)
